...
from models.matching.active_match_schema import ActiveMatch


def test_active_match_valid():
    ...
    # Assertions
    assert active_match.status.value == "pending"  # Enum Status from Match
    assert len(active_match.users) == 2

def test_active_match_invalid_users_length():
